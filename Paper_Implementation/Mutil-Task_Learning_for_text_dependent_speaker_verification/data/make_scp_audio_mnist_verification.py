...
wav_scp_train = './wav_audio_mnist_verification_train.scp'
wav_scp_dev = './wav_audio_mnist_verification_dev.scp'
wav_scp_eval = './wav_audio_mnist_verification_eval.scp'
