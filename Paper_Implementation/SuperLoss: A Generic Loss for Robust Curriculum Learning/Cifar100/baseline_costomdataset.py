...
def prepare_dataset():
    ...
    data_root = "/media/syoon/DATA2/2024_WINTTER_RAB/baseline_code/cifar100_code/data"

    train_set_all = datasets.CIFAR100(root = data_root, train = True, download = True, transform = transform) 
