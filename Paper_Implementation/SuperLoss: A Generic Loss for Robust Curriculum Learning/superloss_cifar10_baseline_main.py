...
from cifar10_code.Superloss_baseline_utils import  format_time, progress_bar
from cifar10_code.Superloss_function import SuperLoss
from cifar10_code.resnet18 import ResNet ,resnet18, resnet34
from utils import *
from cifar10_Data_SL.data import CIFAR10, CIFAR100
import torch
import torch.nn as nn
import torch.optim as optim
...
def main():
    ...
    result_folder = '/media/syoon/DATA2/2024_WINTTER_RAB/baseline_code/cifar10_Data_SL/results/'
...
def test(epoch, testloader, net, criterion):
    ...
    torch.save(state, '/media/syoon/DATA2/2024_WINTTER_RAB/baseline_code/cifar10_Data_SL/checkpoint/current_net')
...
def checkpoint(acc, epoch, net):
    ...
    if not os.path.isdir('checkpoint'):
        os.mkdir('checkpoint')
    torch.save(state, '/media/syoon/DATA2/2024_WINTTER_RAB/baseline_code/cifar10_Data_SL/checkpoint/ckpt.t7.' +
               args.sess)
